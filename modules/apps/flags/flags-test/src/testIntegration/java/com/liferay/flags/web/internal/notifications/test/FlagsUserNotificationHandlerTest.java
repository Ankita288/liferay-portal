...
import com.liferay.flags.MockFlagsEntryService;
	...
	public void testIgnoreTamperedReporterAndReportedUser_MBMessage()
		...
		PortletPreferences portletPreferences =
			PortletPreferencesFactoryUtil.getPortletPreferences(
				mockHttpServletRequest, FlagsPortletKeys.FLAGS);

		portletPreferences.setValue("enabled", "true");

		MockFlagsEntryService mockFlagsEntryService =
			new MockFlagsEntryService();

		try (AutoCloseable autoCloseable =
				ReflectionTestUtil.setFieldValueWithAutoCloseable(
					_mvcActionCommand, "_flagsEntryService",
					mockFlagsEntryService);
			...
			PrincipalThreadLocal.setName(originalPrincipal);
